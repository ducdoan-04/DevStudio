...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="py-16 sm:py-18 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-gray-500">
            Hãy liên hệ ngay với chúng tôi để nhận được những thông tin tư vấn
            về chi phí dịch vụ, cùng nhiều ưu đãi hấp dẫn dành cho bạn!
          </p>
        </div>
              ...
              <form className="mt-6 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-brand-red focus:border-brand-red"
                  />
                </div>
                <div>
