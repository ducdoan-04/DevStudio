...
const albumData: AlbumImage[] = [
  { id: 1, title: 'Love in the mountains', imageUrl: 'https://images.pexels.com/photos/3206093/pexels-photo-3206093.jpeg?auto=compress&cs=tinysrgb&w=600' },
  { id: 2, title: 'A tender moment', imageUrl: 'https://images.pexels.com/photos/1024989/pexels-photo-1024989.jpeg?auto=compress&cs=tinysrgb&w=600' },
  { id: 3, title: 'Urban romance', imageUrl: 'https://images.pexels.com/photos/1709003/pexels-photo-1709003.jpeg?auto=compress&cs=tinysrgb&w=600' },
  { id: 4, title: 'Seaside vows', imageUrl: 'https://images.pexels.com/photos/2253870/pexels-photo-2253870.jpeg?auto=compress&cs=tinysrgb&w=600' },
  { id: 5, title: 'Golden hour bliss', imageUrl: 'https://images.pexels.com/photos/1408332/pexels-photo-1408332.jpeg?auto=compress&cs=tinysrgb&w=600' },
  { id: 6, title: 'First dance', imageUrl: 'https://images.pexels.com/photos/169190/pexels-photo-169190.jpeg?auto=compress&cs=tinysrgb&w=600' },
  { id: 7, title: 'Country charm', imageUrl: 'https://images.pexels.com/photos/301599/pexels-photo-301599.jpeg?auto=compress&cs=tinysrgb&w=600' },
  { id: 8, title: 'Forever starts now', imageUrl: 'https://images.pexels.com/photos/265856/pexels-photo-265856.jpeg?auto=compress&cs=tinysrgb&w=600' },
];

const AlbumCard: React.FC<{ item: AlbumImage }> = ({ item }) => (
  <div className="group relative overflow-hidden bg-gray-100">
    <img src={item.imageUrl} alt={item.title} className="w-full h-full object-cover aspect-[3/4] transition-transform duration-500 group-hover:scale-110" />
