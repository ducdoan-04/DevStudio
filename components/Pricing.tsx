...
const invitationData: Invitation[] = [
  { id: 1, title: 'Thiệp pastel', imageUrl: 'https://i.imgur.com/gKkL2eS.png' },
  { id: 2, title: 'Thiệp cẩm hồng', imageUrl: 'https://i.imgur.com/k6lPqS1.png' },
  { id: 3, title: 'Thiệp hồng tím', imageUrl: 'https://i.imgur.com/6U4i8gL.png' },
  { id: 4, title: 'Thiệp hoa lá bày', imageUrl: 'https://i.imgur.com/2U5w1tD.png' },
  { id: 5, title: 'Thiệp hoa hồng xinh', imageUrl: 'https://i.imgur.com/26P2w6R.png' },
  { id: 6, title: 'Thiệp cổ trướng', imageUrl: 'https://i.imgur.com/N6wEaf7.png' },
  { id: 7, title: 'Thiệp hoa mùa xuân', imageUrl: 'https://i.imgur.com/o1b0s1g.png' },
  { id: 8, title: 'Thiệp hoa', imageUrl: 'https://i.imgur.com/1Yf0Z8H.png' },
];
...
const InvitationCard: React.FC<{ item: Invitation }> = ({ item }) => (
    <div className="text-center group">
      <div className="bg-white p-2 border border-gray-200 rounded-lg shadow-sm group-hover:shadow-lg transition-shadow duration-300">
        <img src={item.imageUrl} alt={item.title} className="w-full h-auto object-contain rounded-md" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-gray-500">
            Những mẫu thiệp cưới mới nhất được Wedding Planer cập nhật & thiết kế theo xu hướng hiện đại độc đáo
          </p>
        </div>
